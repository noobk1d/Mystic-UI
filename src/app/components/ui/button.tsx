...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#ebebeb] text-neutral-900 shadow hover:bg-neutral-100 px-2", // white button
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-input bg-background text-foreground shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-[#1A1A1A] text-white shadow-sm hover:bg-neutral-900",
        ...
        none: "bg-transparent border-none shadow-none text-inherit p-0 m-0 hover:bg-transparent hover:shadow-none focus:ring-0 focus:outline-none",
      },
      size: {
        default: "h-9 rounded-sm px-2 py-1",
        sm: "h-8 rounded-sm px-1 text-xs",
