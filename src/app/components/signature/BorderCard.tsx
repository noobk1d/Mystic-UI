...
export default function BorderCard({
  ...
  // When eraser mode changes, update canvas
  useEffect(() => {
  ...
  // When settings change, always go back to draw mode
  useEffect(() => {
    if (onSettingsChange) {
      onSettingsChange();
    }
      ...
      <CardFooter className="flex justify-between px-3">
        <div className="flex gap-2">
          ...
          <Button
            ...
            className={
              "" + `${eraserAnim ? "scale-95 transition-transform" : ""}`
            }>
            <svg
              viewBox="0 0 24 24"
              fill="none"
              ...
              <g id="SVGRepo_iconCarrier">
                <path
                  ...
                  fill={isErasing ? "#222" : "#6c6c6c"}></path>
              </g>
            </svg>
          </Button>
          {/* Reset Button */}
